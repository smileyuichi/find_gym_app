<div class="searched_heading-box">
    ...
    <div class="searched_heading-box__sort">
        <select name="sort_order" class="sort-order searched_heading-box__sort__select">
            <option value="location.pathname" name="location.pathname">並び替え</option>
            <option value="rate-desc">評価の高い順</option>
            <option value="woms-desc">口コミの多い順</option>
            <option value="clips-desc">保存済みの多い順</option>
            <option value="created_at-desc">登録順</option>
